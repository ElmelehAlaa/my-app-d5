...
class FilmCardsLordOfTheRings extends Component {
  render() {
    return (
      <Row className=" mb-4 no-gutters text-center ">
        <h4 className="text-white mx-5 fs-1 text-start">Lord Of The Rings</h4>
...
export default FilmCardsLordOfTheRings;
